...
// End Cross Module References
	static UEnum* ELoadInfoResult_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_SaveExtension_ELoadInfoResult, Z_Construct_UPackage__Script_SaveExtension(), TEXT("ELoadInfoResult"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ELoadInfoResult(ELoadInfoResult_StaticEnum, TEXT("/Script/SaveExtension"), TEXT("ELoadInfoResult"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_SaveExtension_ELoadInfoResult_Hash() { return 240113956U; }
	UEnum* Z_Construct_UEnum_SaveExtension_ELoadInfoResult()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_SaveExtension();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ELoadInfoResult"), 0, Get_Z_Construct_UEnum_SaveExtension_ELoadInfoResult_Hash(), false);
#else
