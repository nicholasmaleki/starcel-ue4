...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_USlotData_Statics::NewProp_Map = { "Map", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USlotData, Map), METADATA_PARAMS(Z_Construct_UClass_USlotData_Statics::NewProp_Map_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USlotData_Statics::NewProp_Map_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USlotData, 2383884142);
