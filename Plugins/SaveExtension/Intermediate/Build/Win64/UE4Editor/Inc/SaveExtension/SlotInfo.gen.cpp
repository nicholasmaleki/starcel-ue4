...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USlotInfo_Statics::NewProp_FileName_MetaData[] = {
		{ "Category", "SlotInfo" },
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_USlotInfo_Statics::NewProp_FileName = { "FileName", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USlotInfo, FileName), METADATA_PARAMS(Z_Construct_UClass_USlotInfo_Statics::NewProp_FileName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USlotInfo_Statics::NewProp_FileName_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USlotInfo_Statics::NewProp_DisplayName_MetaData[] = {
		{ "Category", "SlotInfo" },
		{ "ModuleRelativePath", "Public/SlotInfo.h" },
	};
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UClass_USlotInfo_Statics::NewProp_DisplayName = { "DisplayName", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USlotInfo, DisplayName), METADATA_PARAMS(Z_Construct_UClass_USlotInfo_Statics::NewProp_DisplayName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USlotInfo_Statics::NewProp_DisplayName_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USlotInfo_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USlotInfo_Statics::NewProp_FileName,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USlotInfo_Statics::NewProp_DisplayName,
	...
	IMPLEMENT_CLASS(USlotInfo, 803942114);
