...
You can install the necessary packages directly using python.exe -m pip install numpy sympy cmdix fast-autocomplete fast-autocomplete[levenshtein] numba kingdon matplotlib scikit-image scikit-learn. If any of these fails, you may need to re-run the command. 
