class Constants:
    def __init__(self):
        ...
        self.default_metric_prefixes = [
            ["quetta","ronna","yotta","zetta","exa","peta","tera","giga","mega","kilo","hecto","deka",None,"deci","centi","milli","micro","nano","pico","femto","atto","zepto","yocto","ronto","quecto"],
...
class WorldSize():
    def __init__(self): # most large world sizes require origin rebasing
        ...
        self.photon_am_weight = 9.52 * 10^(-50) # AM Radio. Using Planck's constant. 2.09024042 × 10^(-28)nm particle width by idiot math using electrons weight and size, 2 orders of magnitude difference between this and planck length
