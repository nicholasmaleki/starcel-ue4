...
from unreal_engine.classes import (
    ...
    Object, StrProperty, IntProperty,
    Material, Texture
)
...
class UnrealTableRenderer:
    ...
    def render_table(self, 
                    ...
                    use_instanced_gridlines: bool = False,
    ...
    def _get_cell_world_position(self, 
        ...
        # CRITICAL FIX: Pad to 3D for 2D tables
    ...
    def _render_cells(self, 
        ...
        # Choose blueprint based on mode
        ...
        try:
            ...
            if self.aggressive_debug:
                ue.log_warning(f"Could not load blueprint {blueprint_path}, using placeholders")
        ...
        if self.aggressive_debug:
            ue.log(f"Rendered {len(self.cell_actors)} cells in {self.text_mode} mode")
