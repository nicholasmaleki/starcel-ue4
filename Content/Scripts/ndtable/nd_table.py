"""
nD Table - Multi-dimensional table with negative indexing, formulas, and dependency tracking

A powerful n-dimensional table library supporting:
- Negative indices and custom axis labels
- Formula engine with lazy/eager evaluation
- Dependency graph and automatic propagation
- Spreadsheet-style access (A1, B2, etc.)
- Multi-dimensional spreading
- Optional PGA (Projective Geometric Algebra) support
